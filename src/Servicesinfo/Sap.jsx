    ...
    return (
        ...
        <div className=" mt-5" style={{backgroundColor:'whitesmoke'}}>
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    >
                       Our SAP solutions are designed to help businesses streamline operations, enhance efficiency, and unlock the full potential of their enterprise systems. As a leader in enterprise resource planning (ERP) software, SAP offers a suite of integrated solutions that cover everything from finance and supply chain management to human resources and customer relations. We provide tailored SAP implementations, optimizations, and support services that enable organizations to improve decision-making, reduce costs, and drive growth. Whether you're looking to upgrade your current SAP system or implement SAP for the first time, our expert team ensures a smooth, customized approach to meet your unique business requirements
                    </motion.p>
                </div>
        ...
        <div className="container-fluid py-5 bg-light">
                <div className="row align-items-center animate-section hidden">
                    ...
                    Sap solutions has become an integral part of the digital landscape, revolutionizing the way we interact with technology. In this dynamic field, Techno Softwares emphasizes a user-centric approach, focusing on creating seamless and intuitive experiences. Techno Softwares combines expertise with an in-depth understanding of user requirements.

Our dedication to delivering high-quality and user-friendly applications positions us as a trusted partner for businesses to make an everlasting impact in the digital landscape. As the solutions continues to develop, Techno Softwares remains at the forefront, shaping the future of mobile application experiences with expertise and creativity.
                        </h4>
