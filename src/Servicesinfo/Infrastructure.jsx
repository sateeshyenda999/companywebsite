    ...
    return (
        ...
        <div className=" mt-5" style={{backgroundColor:'whitesmoke'}}>
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    >
                        We provide a comprehensive range of services for infrastructure, aimed at supporting the development, maintenance, and enhancement of essential systems. Our team is dedicated to delivering high-quality solutions that ensure the longevity and efficiency of infrastructure projects, from transportation networks to energy systems. Whether it's construction, planning, or ongoing maintenance, we tailor our services to meet the unique needs of each project, helping our clients achieve reliable, sustainable results
                    </motion.p>
                </div>
        ...
        <div className="container-fluid py-5 bg-light">
                <div className="row align-items-center animate-section hidden">
                    ...
                    BInfrastructurehas become an integral part of the digital landscape, revolutionizing the way we interact with technology. In this dynamic field, Techno Softwares emphasizes a user-centric approach, focusing on creating seamless and intuitive experiences. Techno Softwares combines expertise with an in-depth understanding of user requirements.

Our dedication to delivering high-quality and user-friendly applications positions us as a trusted partner for businesses to make an everlasting impact in the digital landscape. As the  services  continues to develop, Techno Softwares remains at the forefront, shaping the future of mobile application experiences with expertise and creativity.
                        </h4>
