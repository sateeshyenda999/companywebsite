...
import BackenddevelopmentServices from "./Backenddevelopmentservices"
    ...
    return (
        ...
        <div className="container-fluid py-5 bg-light">
                <div className="row align-items-center animate-section hidden">
                    ...
                    Back end development has become an integral part of the digital landscape, revolutionizing the way we interact with technology. In this dynamic field, Techno Softwares emphasizes a user-centric approach, focusing on creating seamless and intuitive experiences. Techno Softwares combines expertise with an in-depth understanding of user requirements.
